...
def process_input():
    ...
    if keys[pygame.K_t] and not previous_keys[pygame.K_t]:
        ...
        if training:
            ...
            position = bat.get_best_position()
...
d = 4 # dimensionality of solution-space
n = 40 # size of population, related to amount of bees, bats and fireflies
range_min=[0.0, 10.0, 0.0, 0.0]
range_max = [0.9, 200.0, 1300.0, 30.0]
hyperparams.d=d 
hyperparams.n=n 
...
pygame.display.set_caption("Experiment 2 - Lower - Line Follower Optimization")
